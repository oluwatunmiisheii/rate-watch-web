  ...
  return (
    <Container className="sm:my-5">
      <div className="flex items-start justify-between mb-4 md:mb-0">
        <div>
          <h1 className="leading-none text-2xl text-gray-900 font-bold">Privacy Policy</h1>
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          protecting your personal data. This privacy policy explains how we collect, use, and share
          information about you when you use our application and services.
        </p>
        ...
        <p className="mb-4">
          ...
          the rates displayed in the app will be available or applicable when you use the providers
          services.
        </p>
        ...
        <p className="mb-4">
          ...
          exercise these rights, please contact us at [Your Contact Information].
        </p>
